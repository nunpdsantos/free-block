...
- Block design: sharp 3D raised tiles — flat face (no dome gradient, only subtle top sheen), thick hard bevels (`box-shadow inset` 4px top/bottom, 3.5px sides at high opacity: 0.65 highlight / 0.75 shadow), 2px border-radius, outer lift shadow. Board bg `#161A33`, empty cells `#1E2244` for strong contrast. DragOverlay matches with heavier drop shadow. PiecePreview uses proportionally scaled 3px bevels
