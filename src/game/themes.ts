...
export const THEMES: Theme[] = [
  ...
  },
  {
    ...
    bgPalettes: [
      { score: 0,    bg: '#1A1A2E', bgDark: '#0F0F1A' },
      { score: 500,  bg: '#1A2E2A', bgDark: '#0F1A18' },
      { score: 1500, bg: '#2E1A2E', bgDark: '#1A0F1A' },
      { score: 3000, bg: '#2E2A1A', bgDark: '#1A180F' },
      { score: 5000, bg: '#2E1A22', bgDark: '#1A0F14' },
      { score: 8000, bg: '#1A1A30', bgDark: '#0F0F1C' },
    ],
    swatchFrom: '#1A1A1A',
    swatchTo: '#333333',
  },
